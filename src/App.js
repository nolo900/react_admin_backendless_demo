...
function App() {
  ...
  return(
    <Admin
      ...
      { permissions => [
          // allow(permissions, 'SUPER_ADMIN') ? <WelcomeBanner role="Site Scan Admin" /> : null,
          allow(permissions, 'SUPER_ADMIN') ? <Resource name="Users" icon={UserIcon} list={UserList} edit={UserEdit} create={UserCreate} /> : null,
          allow(permissions, 'SUPER_ADMIN') ? <Resource name="Site" options={{ label: 'Sites' }} icon={EventIcon} list={SiteList} edit={SiteEdit} create={SiteCreate} /> : null,
          allow(permissions, 'SUPER_ADMIN') ? <Resource name="Lessee" icon={EventIcon} list={LesseeList} edit={LesseeEdit} create={LesseeCreate} /> : null,
          allow(permissions, 'SUPER_ADMIN') ? <Resource name="ServiceProvider" options={{label:'Service Providers'}} icon={EventIcon} list={ServiceProviderList} edit={ServiceProviderEdit} create={ServiceProviderCreate}/> : null,
          allow(permissions, 'SUPER_ADMIN') ? <Resource name="ServiceLog" options={{label:'Service Log'}} icon={EventIcon} list={ServiceLogList} /> : null,

          // allow(permissions, 'LESSEE_ADMIN') ? <Resource name="" options={} />
