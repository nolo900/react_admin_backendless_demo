...
import { LeaseeList, LeaseeEdit, LeaseeCreate } from './components/LeaseeTable';
...
function App() {
  ...
  return(
    <Admin dashboard={Dashboard} dataProvider={dataProvider} authProvider={authProvider} >
      ...
      <Resource name="Service Company" icon={EventIcon} list={ServiceCompanyList} edit={ServiceCompanyEdit} create={ServiceCompanyCreate} />
      <Resource name="Leasee" icon={EventIcon} list={LeaseeList} edit={LeaseeEdit} create={LeaseeCreate} />
      {/* {permissions => [
